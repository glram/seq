...
public:
  ...
  void visit(PointerValue *v) override;
  ...
  void visit(YieldInInstr *i) override;
  ...
  template <typename T, typename ...Args> decltype(auto) process(const std::unique_ptr<T> &x, Args&&... args) {
